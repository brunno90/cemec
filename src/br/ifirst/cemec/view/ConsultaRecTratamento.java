 ...
 * @author Iagho
 */
public class ConsultaRecTratamento extends javax.swing.JDialog {

    public ConsultaRecTratamento(JDialog aThis, boolean b) {
        super(aThis, b);
        initComponents();
        setLocationRelativeTo(null);
    }

    public ConsultaRecTratamento(JFrame aThis, boolean b) {
        super(aThis, b);
        initComponents();
        setLocationRelativeTo(null);
    }
    ...
    private void Imprimir() {
        ...
        try {
            ...
            URL arquivo = getClass().getResource("/br/ifirst/cemec/relatorios/RecomendacaoTratamento.jasper");
            Map<String, Object> datIni = new HashMap<String, Object>();
            datIni.put("cd_ini", cd_ini); //Filtro
            datIni.put("cd_fin", cd_fin); //Filtro
