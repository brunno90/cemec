 ...
 * @author Iagho
 */
public class ConsultaTratamento extends javax.swing.JDialog {

    public ConsultaTratamento(JDialog aThis, boolean b) {
        super(aThis, b);
        initComponents();
        setLocationRelativeTo(null);
    }

    public ConsultaTratamento(JFrame aThis, boolean b) {
        super(aThis, b);
        initComponents();
        setLocationRelativeTo(null);
    }
    ...
    private void Imprimir() {
        ...
        try {
            String caminhoRel = "/br/ifirst/cemec/relatorios/Tratamento.jasper";
...
//            jrviewer.toFront();
            JasperExportManager.exportReportToPdfFile(jasperPrint, "C:\\NovaPasta\\tratamento.pdf");
            Runtime.getRuntime().exec("cmd /c start C:\\NovaPasta\\tratamento.pdf");
            File file = new File("C:\\NovaPasta\\tratamento.pdf");
            file.deleteOnExit();
        } catch (Exception ex) {
